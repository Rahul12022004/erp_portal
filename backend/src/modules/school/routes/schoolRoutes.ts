...
import Announcement from "../../communication/models/Announcement";
import Assignment from "../../academics/models/Assignment";
import Attendance from "../../academics/models/Attendance";
import ClassModel from "../../academics/models/Class";
import ClassFeeStructure from "../../finance/models/ClassFeeStructure";
import DataImportBatch from "../../data-import/models/DataImportBatch";
import Exam from "../../academics/models/Exam";
import Finance from "../../finance/models/Finance";
import Hostel from "../../hostel/models/Hostel";
import InventoryItem from "../../inventory/models/InventoryItem";
import InvestorLedger from "../../finance/models/InvestorLedger";
import LeaveApplication from "../../staff/models/LeaveApplication";
import LibraryAssignment from "../../library/models/LibraryAssignment";
import LibraryBook from "../../library/models/LibraryBook";
import Log from "../../logs/models/Logs";
import Maintenance from "../../maintenance/models/Maintenance";
import Mark from "../../academics/models/Mark";
import SalaryRole from "../../finance/models/SalaryRole";
import SocialMedia from "../../social/models/SocialMedia";
import StudentFeeAssignment from "../../finance/models/StudentFeeAssignment";
import StudentFeePayment from "../../finance/models/StudentFeePayment";
