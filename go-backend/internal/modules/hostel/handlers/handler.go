...
type Handler struct{ repo *repositories.HostelRepo }

func New(r *repositories.HostelRepo) *Handler { return &Handler{repo: r} }
...
func (h *Handler) Get(c *fiber.Ctx) error {
	...
	if err != nil || item == nil {
		return response.NotFound(c, "hostel not found")
	}
	return response.OK(c, item)
}

func (h *Handler) Create(c *fiber.Ctx) error {
	var item domain.Hostel
